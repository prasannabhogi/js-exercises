...
document.writeln("Name is "+name+" of Age "+age+" living in"+city+"<br>");
document.writeln("Prasanna is a student"+isstudent+"<br>");
...
age=17;
var eligibility=age>=18?"Congrats! You are eligible to Vote":"Sorry You are not eligible to Vote.Wait for "+(18-age)+" more years";
...
age=10;
if(age<18)
    document.write("You are considered as a minor!"+"<br>");
else if(age>=18 && age<65)
    document.write("you are considered as an adult "+"<br>");
else
document.write("you are considered as a senior citizen"+"<br>");